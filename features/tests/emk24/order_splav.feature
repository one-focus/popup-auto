...
Feature: Проверка Заказ сплава emk24
  ...
  Scenario Outline: Заказ сплава emk24
    ...
    Then email with "generated_test_automation_email_order_splav" contains "<url>;Обратный звонок (заявка);[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com" in 900 sec
