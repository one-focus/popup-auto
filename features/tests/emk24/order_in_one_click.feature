...
Feature: Проверка кнопки Заказать в 1 клик emk24
  ...
  Scenario Outline: emk24
    ...
    Then email with "generated_test_automation_email_order_1_click" contains "<url>;test_automation_user_name;test_company_name;[PHONE]: +70000000000;[EMAIL]: automation.emk@gmail.com" in 900 sec
