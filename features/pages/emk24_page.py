...
class Emk24Page(BasePage):
    ...
    FIELD_PHONE = By.XPATH, '//*[@name="phone"]|//*[@name="FIELDS[WORK_PHONE]"]|//input[@placeholder="Телефон"]'
    FIELD_EMAIL = By.XPATH, '//input[@name="email"]|//*[@name="mail"]|//input[@name="FIELDS[EMAIL]"]|//input[@placeholder="Email"]'
    ...
    BUTTON_SEND = By.XPATH, '//div[@class="step2"]//span[@class="but_big_card js-continue"]|//input[@type="submit"]'
    FORM_MODAL = By.XPATH, '//div[@role="dialog" and contains(@style,"display: block;")]'
    # vacancy page
    FIELD_VACANCY_NAME = By.XPATH, '//input[@name="PROPERTY_VALUES[UNAME]"]'
    FIELD_VACANCY_PHONE = By.XPATH, '//input[@name="PROPERTY_VALUES[PHONE]"]'
